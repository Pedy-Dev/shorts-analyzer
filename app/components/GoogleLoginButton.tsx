...
export default function GoogleLoginButton({ returnUrl }: GoogleLoginButtonProps) {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="flex items-center justify-center gap-3 w-full max-w-sm px-6 py-3 bg-white border border-gray-300 rounded-lg shadow-sm hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
    >
      {loading ? (
